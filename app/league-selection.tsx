...
const COUNTRY_DATA: Record<string, {
  ...
  GB: {
    ...
    association: "FA",
    regions: [
      { code: "NL_NORTH", name: "National League North", enabled: true },
      { code: "NL_SOUTH", name: "National League South", enabled: true },
      { code: "NPL", name: "Northern Premier League", enabled: false },
      { code: "SPL", name: "Southern Football League", enabled: false },
      { code: "IL", name: "Isthmian League", enabled: false },
    ],
    leagues: [
      { level: 5, name: "National League", hasRegions: false },
      { level: 6, name: "National League N/S", hasRegions: true },
      { level: 7, name: "Step 3", hasRegions: true },
      { level: 8, name: "Step 4", hasRegions: true },
      { level: 9, name: "Step 5", hasRegions: true },
      { level: 10, name: "Step 6", hasRegions: true },
    ],
  },
  NL: {
    name: "Nederland",
    ...
    association: "KNVB",
    regions: [
      { code: "KNVB_WEST1", name: "West I", enabled: true },
      { code: "KNVB_WEST2", name: "West II", enabled: false },
      { code: "KNVB_NOORD", name: "Noord", enabled: false },
      { code: "KNVB_OOST", name: "Oost", enabled: false },
      { code: "KNVB_ZUID1", name: "Zuid I", enabled: false },
    ],
    leagues: [
      { level: 4, name: "Derde Divisie", hasRegions: true },
      { level: 5, name: "Hoofdklasse", hasRegions: true },
      { level: 6, name: "Eerste Klasse", hasRegions: true },
      { level: 7, name: "Tweede Klasse", hasRegions: true },
      { level: 8, name: "Derde Klasse", hasRegions: true },
      { level: 9, name: "Vierde Klasse", hasRegions: true },
    ],
  },
  BE: {
    name: "België",
    ...
    association: "KBVB",
    regions: [
      { code: "VV", name: "Voetbal Vlaanderen", enabled: true },
      { code: "ACFF", name: "ACFF (Francophone)", enabled: false },
      { code: "ANTW", name: "Antwerpen", enabled: false },
      { code: "BRAB", name: "Brabant", enabled: false },
      { code: "LIMB", name: "Limburg", enabled: false },
    ],
    leagues: [
      { level: 4, name: "Eerste Amateur", hasRegions: true },
      { level: 5, name: "Tweede Amateur", hasRegions: true },
      { level: 6, name: "Derde Amateur", hasRegions: true },
      { level: 7, name: "1e Provinciale", hasRegions: true },
      { level: 8, name: "2e Provinciale", hasRegions: true },
      { level: 9, name: "3e Provinciale", hasRegions: true },
    ],
  },
  DK: {
    name: "Danmark",
    ...
    association: "DBU",
    regions: [
      { code: "DBU_JYL", name: "Jylland", enabled: true },
      { code: "DBU_SJL", name: "Sjælland", enabled: false },
      { code: "DBU_FYN", name: "Fyn", enabled: false },
    ],
    leagues: [
      { level: 3, name: "2. Division", hasRegions: true },
      { level: 4, name: "Danmarksserien", hasRegions: true },
      { level: 5, name: "Jyllandsserien", hasRegions: true },
      { level: 6, name: "Serie 1", hasRegions: true },
      { level: 7, name: "Serie 2", hasRegions: true },
    ],
  },
  SE: {
    name: "Sverige",
    ...
    association: "SvFF",
    regions: [
      { code: "STFF", name: "Stockholms FF", enabled: true },
      { code: "GBGFF", name: "Göteborgs FF", enabled: false },
      { code: "SKFF", name: "Skånes FF", enabled: false },
      { code: "VGFF", name: "Västergötlands FF", enabled: false },
    ],
    leagues: [
      { level: 3, name: "Division 1", hasRegions: true },
      { level: 4, name: "Division 2", hasRegions: true },
      { level: 5, name: "Division 3", hasRegions: true },
      { level: 6, name: "Division 4", hasRegions: true },
      { level: 7, name: "Division 5", hasRegions: true },
      { level: 8, name: "Division 6", hasRegions: true },
      { level: 9, name: "Division 7", hasRegions: true },
    ],
  },
  FR: {
    name: "France",
    ...
    association: "FFF",
    regions: [
      { code: "IDF", name: "Île-de-France", enabled: true },
    ...
    leagues: [
      { level: 4, name: "National 2", hasRegions: true },
      { level: 5, name: "National 3", hasRegions: true },
      { level: 6, name: "Régional 1", hasRegions: true },
      { level: 7, name: "Régional 2", hasRegions: true },
      { level: 8, name: "Régional 3", hasRegions: true },
      { level: 9, name: "District 1", hasRegions: true },
      { level: 10, name: "District 2", hasRegions: true },
    ],
  },
  IT: {
    name: "Italia",
    ...
    association: "FIGC",
    regions: [
      { code: "LOM", name: "Lombardia", enabled: true },
      ...
      { code: "PIE", name: "Piemonte", enabled: false },
      { code: "TOS", name: "Toscana", enabled: false },
    ],
    leagues: [
      { level: 4, name: "Serie D", hasRegions: true },
      { level: 5, name: "Eccellenza", hasRegions: true },
      { level: 6, name: "Promozione", hasRegions: true },
      { level: 7, name: "Prima Categoria", hasRegions: true },
      { level: 8, name: "Seconda Categoria", hasRegions: true },
      { level: 9, name: "Terza Categoria", hasRegions: true },
    ],
  },
  ES: {
    name: "España",
    ...
    association: "RFEF",
    regions: [
      { code: "AND", name: "Andalucía", enabled: true },
      { code: "CAT", name: "Catalunya", enabled: false },
      { code: "MAD", name: "Madrid", enabled: false },
      { code: "VAL", name: "Comunitat Valenciana", enabled: false },
      { code: "GAL", name: "Galicia", enabled: false },
      { code: "PVA", name: "País Vasco", enabled: false },
    ],
    leagues: [
      { level: 4, name: "Segunda RFEF", hasRegions: true },
      { level: 5, name: "Tercera RFEF", hasRegions: true },
      { level: 6, name: "Regional Preferente", hasRegions: true },
      { level: 7, name: "Primera Regional", hasRegions: true },
      { level: 8, name: "Segunda Regional", hasRegions: true },
    ],
  },
};
