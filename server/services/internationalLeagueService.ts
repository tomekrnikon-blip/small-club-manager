...
export const COUNTRIES: Country[] = [
  ...
  },
  {
    ...
    associationCode: "FFF",
    website: "https://fff.fr",
    language: "fr",
    enabled: true,
    leagueLevels: [
      { level: 1, name: "Ligue 1", nameLocal: "Ligue 1", hasRegions: false },
      { level: 2, name: "Ligue 2", nameLocal: "Ligue 2", hasRegions: false },
      { level: 3, name: "National", nameLocal: "Championnat National", hasRegions: false },
      { level: 4, name: "National 2", nameLocal: "National 2", hasRegions: true },
      { level: 5, name: "National 3", nameLocal: "National 3", hasRegions: true },
      { level: 6, name: "Régional 1", nameLocal: "Régional 1", hasRegions: true },
      { level: 7, name: "Régional 2", nameLocal: "Régional 2", hasRegions: true },
      { level: 8, name: "Régional 3", nameLocal: "Régional 3", hasRegions: true },
      { level: 9, name: "District 1", nameLocal: "District 1", hasRegions: true },
      { level: 10, name: "District 2", nameLocal: "District 2", hasRegions: true },
    ],
  },
  {
    code: "IT",
    ...
    associationCode: "FIGC",
    website: "https://figc.it",
    language: "it",
    enabled: true,
    leagueLevels: [
      { level: 1, name: "Serie A", nameLocal: "Serie A", hasRegions: false },
      { level: 2, name: "Serie B", nameLocal: "Serie B", hasRegions: false },
      { level: 3, name: "Serie C", nameLocal: "Serie C", hasRegions: true },
      { level: 4, name: "Serie D", nameLocal: "Serie D", hasRegions: true },
      { level: 5, name: "Eccellenza", nameLocal: "Eccellenza", hasRegions: true },
      { level: 6, name: "Promozione", nameLocal: "Promozione", hasRegions: true },
      { level: 7, name: "Prima Categoria", nameLocal: "Prima Categoria", hasRegions: true },
      { level: 8, name: "Seconda Categoria", nameLocal: "Seconda Categoria", hasRegions: true },
      { level: 9, name: "Terza Categoria", nameLocal: "Terza Categoria", hasRegions: true },
    ],
  },
  {
    code: "ES",
    ...
    associationCode: "RFEF",
    website: "https://rfef.es",
    language: "es",
    enabled: true,
    leagueLevels: [
      { level: 1, name: "La Liga", nameLocal: "La Liga", hasRegions: false },
      { level: 2, name: "Segunda", nameLocal: "Segunda División", hasRegions: false },
      { level: 3, name: "Primera RFEF", nameLocal: "Primera Federación", hasRegions: false },
      { level: 4, name: "Segunda RFEF", nameLocal: "Segunda Federación", hasRegions: true },
      { level: 5, name: "Tercera RFEF", nameLocal: "Tercera Federación", hasRegions: true },
      { level: 6, name: "Regional Preferente", nameLocal: "Regional Preferente", hasRegions: true },
      { level: 7, name: "Primera Regional", nameLocal: "Primera Regional", hasRegions: true },
      { level: 8, name: "Segunda Regional", nameLocal: "Segunda Regional", hasRegions: true },
    ],
  },
];
